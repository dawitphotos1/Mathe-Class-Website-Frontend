...
const DebugWrapper = ({ children }) => {
  ...
  return (
    <>
      ...
      {showDebug && <div style={{ position: 'fixed', bottom: 60, right: 20, padding: 10, background: '#fff', border: '1px solid #ccc', zIndex: 998 }}>Debug Panel</div>}
    </>
  );
};
        ...
        <main style={{ minHeight: "calc(100vh - 200px)" }}>
          <Suspense fallback={<Loading />}>
            <Routes>
              ...
              <Route path="/register" element={<RoleRoute publicRoute={true}><Pages.Register /></RoleRoute>} />
              <Route path="/login" element={<RoleRoute publicRoute={true}><Pages.Login /></RoleRoute>} />
              <Route path="/forgot-password" element={<Pages.ForgotPassword />} />
              <Route path="/reset-password" element={<Pages.ResetPassword />} />
              <Route path="/contact" element={<Contact />} />
              <Route path="/confirm-account" element={<Pages.ConfirmAccount />} />

              {/* ==================== COURSE ROUTES ==================== */}
              <Route path="/courses" element={<Pages.Courses />} />
              <Route path="/courses/:slug" element={<Pages.CourseViewer />} />
              <Route path="/courses/id/:id" element={<Pages.CourseViewer />} />

              {/* ==================== PREVIEW ROUTES ==================== */}
              <Route path="/preview/:lessonId" element={<Pages.PreviewLessonPage />} />
              <Route path="/courses/:courseId/preview" element={<Pages.PreviewLessonPage />} />
              <Route path="/lessons/:lessonId/preview" element={<RoleRoute allowedRoles={["teacher", "student", "admin"]} redirectPath="/unauthorized"><Pages.PreviewLesson /></RoleRoute>} />
              ...
              {/* ==================== ADMIN ROUTES ==================== */}
              <Route path="/admin/*" element={
                <RoleRoute allowedRoles={["admin"]} redirectPath="/unauthorized">
                  <DebugWrapper>
                    <AdminLayout />
                  </DebugWrapper>
                </RoleRoute>
                ...
                <Route path="lesson-logs" element={<AdminLessonLogs />} />
                <Route path="file-manager" element={<Pages.FileManager />} />
              </Route>

              {/* ==================== TEACHER ROUTES ==================== */}
              <Route path="/teacher-dashboard" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><DebugWrapper><Pages.MyTeachingCourses /></DebugWrapper></RoleRoute>} />
              <Route path="/teacher/courses/:courseId/view" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.TeacherCourseViewer /></RoleRoute>} />
              <Route path="/create-course" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.CreateCourse /></RoleRoute>} />
              <Route path="/create-course-advanced" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.CreateCourseWithUnits /></RoleRoute>} />
              <Route path="/courses/:courseId/edit" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.EditCourse /></RoleRoute>} />
              <Route path="/courses/:courseId/manage-lessons" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.TeacherManageLessons /></RoleRoute>} />
              <Route path="/courses/:courseId/lessons/new" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.CreateLessonPage /></RoleRoute>} />
              <Route path="/lessons/:lessonId/edit" element={<RoleRoute allowedRoles={["teacher", "admin"]} redirectPath="/unauthorized"><Pages.EditLesson /></RoleRoute>} />

              {/* ==================== STUDENT ROUTES ==================== */}
              <Route path="/my-courses" element={<RoleRoute allowedRoles={["student", "teacher", "admin"]} redirectPath="/unauthorized"><Pages.MyCoursesPage /></RoleRoute>} />
              <Route path="/courses/:courseId/view" element={<RoleRoute allowedRoles={["student", "teacher", "admin"]} redirectPath="/unauthorized"><Pages.CourseViewer /></RoleRoute>} />
              <Route path="/courses/:courseId/view-lessons" element={<RoleRoute allowedRoles={["student", "teacher", "admin"]} redirectPath="/unauthorized"><Pages.CourseLessons /></RoleRoute>} />
              <Route path="/student/courses/:courseId/lessons" element={<RoleRoute allowedRoles={["student"]} redirectPath="/unauthorized"><Pages.StudentLessons /></RoleRoute>} />
              <Route path="/profile" element={<RoleRoute allowedRoles={["student", "teacher", "admin"]}><Pages.Profile /></RoleRoute>} />

              {/* ==================== PAYMENT ROUTES ==================== */}
              <Route path="/payment/:courseId" element={<RoleRoute allowedRoles={["student"]} redirectPath="/unauthorized"><Pages.PaymentPage /></RoleRoute>} />
              <Route path="/payment-success" element={<RoleRoute allowedRoles={["student"]} redirectPath="/unauthorized"><Pages.PaymentSuccess /></RoleRoute>} />
              <Route path="/payment-cancel" element={<Pages.PaymentCancel />} />
              <Route path="/cancel" element={<Pages.Cancel />} />
