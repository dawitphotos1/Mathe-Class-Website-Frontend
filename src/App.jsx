...
// // // src/App.jsx - CLEAN AND COMPLETE VERSION WITH AUTH FIX
// // import React, { Suspense, useState } from "react";
// // import { Routes, Route, Navigate } from "react-router-dom";
// // import { ThemeProvider } from "./context/ThemeContext";
// // import { AuthProvider, useAuth } from "./context/AuthContext";
...
// //   // Show loading only if auth is still checking and no timeout
// //   if ((loading || !checked) && !showFallback) {
// //     return <Loading />;
// //   }
  
// //   // Log for debugging
// //   console.log("AppContent render - Auth state:", { loading, checked, showFallback });
...
======================= */
const PublicRoute = ({ children }) => {
  const { isAuthenticated, user, checked } = useAuth();
