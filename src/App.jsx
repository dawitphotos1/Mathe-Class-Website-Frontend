...
import DebugLessonData from "./components/DebugLessonData";
...
const CourseViewer = React.lazy(() => import("./pages/courses/CourseViewer")); // UPDATED: For course details view
        ...
        <main style={{ minHeight: "calc(100vh - 200px)" }}>
          <Suspense fallback={<Loading />}>
            <Routes>
              ...
              {/* Course details by slug (public viewing) */}
              <Route path="/courses/:slug" element={<CourseViewer />} />
              
              {/* Course details by ID (fallback route) */}
              <Route path="/courses/id/:id" element={<CourseViewer />} />
              
              {/* Legacy course detail route (deprecated - redirects to CourseViewer) */}
              <Route 
                path="/courses/detail/:slug" 
                element={<Navigate to="/courses/:slug" replace />} 
              />
              ...
              {/* Course viewer for enrolled students */}
              <Route
