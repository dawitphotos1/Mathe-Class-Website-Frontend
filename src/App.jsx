...
// // Mathe-Class-Website-Frontend/src/App.jsx
// import React, { useState, useEffect, Suspense } from "react";
// import { Routes, Route, useNavigate } from "react-router-dom";
// import { ToastContainer, toast } from "react-toastify";
// import "react-toastify/dist/ReactToastify.css";
...
// Lazy imports
const Home = React.lazy(() => retryLazy(() => import("./Pages/Home")));
const Register = React.lazy(() => retryLazy(() => import("./Pages/auth/Register")));
const CourseList = React.lazy(() => retryLazy(() => import("./Pages/courses/CourseList")));
const CourseDetail = React.lazy(() => retryLazy(() => import("./Pages/courses/CourseDetail")));
const CourseCreator = React.lazy(() => retryLazy(() => import("./Pages/courses/CourseCreator")));
const Profile = React.lazy(() => retryLazy(() => import("./Pages/users/Profile")));
const AdminDashboard = React.lazy(() => retryLazy(() => import("./Pages/AdminDashboard")));
const Payment = React.lazy(() => retryLazy(() => import("./Pages/payments/Payment")));
const Success = React.lazy(() => retryLazy(() => import("./Pages/payments/Success")));
const Cancel = React.lazy(() => retryLazy(() => import("./Pages/payments/Cancel")));
const NotFound = React.lazy(() => retryLazy(() => import("./Pages/NotFound")));
