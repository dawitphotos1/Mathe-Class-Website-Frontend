// src/Pages/AdminDashboard.jsx - UPDATED VERSION
...
const AdminDashboard = () => {
  ...
  // 🎯 DIAGNOSTIC SCRIPT - Add this useEffect
  useEffect(() => {
    console.log('AdminDashboard Environment:', {
      ...
      adminCSSLoaded: Array.from(document.styleSheets).some(sheet => 
        sheet.href && sheet.href.includes('AdminDashboard')
      ),
      windowWidth: window.innerWidth,
      theme: theme
    });
    
    // Log CSS classes to see if they're applied
    const adminLayout = document.querySelector('.admin-layout');
    const adminSidebar = document.querySelector('.admin-sidebar');
    const adminMainContent = document.querySelector('.admin-main-content');
    
    console.log('CSS Classes Check:', {
      adminLayout: adminLayout ? 'found' : 'missing',
      adminSidebar: adminSidebar ? 'found' : 'missing',
      adminMainContent: adminMainContent ? 'found' : 'missing',
      adminLayoutClasses: adminLayout?.className,
      adminSidebarClasses: adminSidebar?.className,
      adminMainContentClasses: adminMainContent?.className
    });
  }, [theme]);
