...
const PreviewLessonPage = () => {
  ...
  const fetchPreviewLesson = async () => {
    try {
      ...
      // Otherwise fetch from API
      const response = await axiosInstance.get(`/files/preview-lesson/${lessonId}`);
        ...
        return (
          <div className="video-container">
            {lesson.video_url ? (
              ...
              <div className="no-content">No video available for this lesson.</div>
            )}
          </div>
        );
        ...
        return (
          <div className="pdf-container">
            {lesson.file_url ? (
              ...
              <div className="no-content">No PDF available for this lesson.</div>
            )}
          </div>
        );
        ...
        return (
          <div className="text-content">
            {lesson.content ? (
              ...
              <div className="no-content">No content available for this lesson.</div>
            )}
          </div>
        );
    }
