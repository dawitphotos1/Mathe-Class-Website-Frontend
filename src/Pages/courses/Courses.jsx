...
//           from: `/courses`,
//           redirectMessage:
//             "Please register as a student to enroll in this course",
...
//       toast.info(
//         "Only students can enroll in courses. Please register as a student."
//       );
//       navigate("/register", {
//         state: {
//           redirectMessage:
//             "Please register with a student account to enroll in courses",
//         },
//       });
//       return;
//     }
...
//           <p>
//             Your enrollment is pending admin approval. You'll receive an email
//             once approved.
//           </p>
//         </div>
...
//           <p>
//             <strong>Note:</strong> Click "Enroll Now" to register as a student
//             and enroll in courses. You need to create a student account first.
//           </p>
//         </div>
//       );
//     }
...
//           <p>
//             <strong>Note:</strong> You are enrolled in {enrolledCourses.length}{" "}
//             course(s). Enrolled courses show "Access Course" button.
//           </p>
//         </div>
//       );
//     }
...
//       <div className="course-list">{courses.map(renderCourseItem)}</div>
//     </div>
//   );
// };
...
const Courses = () => {
    ...
    try {
      ...
      if (user?.role === "teacher") {
        ...
        try {
          ...
          console.log("No preview lesson found, trying first lesson");
        }
      ...
      // Get preview lesson for non-teachers
  ...
  const getCourseActionButtons = (course) => {
    ...
    // ✅ FIX: Show Free Preview for everyone (including teachers)
    buttons.push({
      text: user?.role === "teacher" ? "View Preview" : "Free Preview",
      className: "btn-preview",
      onClick: () => handleFreePreview(course),
    });
    ...
    if (user?.role === "teacher") {
      return (
        <div className="teacher-notice">
          <p>
            <strong>👨🏫 Teacher Mode:</strong> You can view previews of all courses.
            To create or manage your own courses, go to the Teacher Dashboard.
          </p>
        </div>
      );
    }
