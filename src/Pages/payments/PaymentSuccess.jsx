  ...
  useEffect(() => {
    ...
    const confirmPayment = async () => {
      try {
        ...
        // 🛠️ FIXED: Use the correct API endpoint
        // Your backend routes are mounted at /api/v1/payments (plural)
    ...
    <div className="success-container">
      <div className="info-box">
        ...
        <div className="buttons">
          ...
          <Link to="/courses" className="btn btn-secondary">Browse More Courses</Link>
          <a href="mailto:support@matheclass.com" className="btn btn-support">Contact Support</a>
        </div>
      </div>
    </div>
  );
