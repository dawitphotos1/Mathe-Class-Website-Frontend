...
const MyTeachingCourses = () => {
  ...
  // ✅ FIXED: Enhanced preview lesson handler
  const handlePreviewLesson = async (lesson, course) => {
    try {
      console.log('🔍 Previewing lesson:', {
        lessonId: lesson.id,
      ...
      const previewWindow = window.open(fullPreviewUrl, '_blank', 'width=1200,height=800,scrollbars=yes');
      ...
      console.error('❌ Preview error:', error);
      showSnackbar('Failed to open preview: ' + error.message, 'error');
    }
  };
