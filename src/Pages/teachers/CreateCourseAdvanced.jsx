...
//             value={unit.title}
//             onChange={(e) =>
//               updateUnitField(unit.id, "title", e.target.value)
//             }
//           />
...
//                 value={lesson.title}
//                 onChange={(e) =>
//                   updateLessonField(unit.id, lesson.id, "title", e.target.value)
//                 }
//               />
...
//                 onChange={(e) =>
//                   updateLessonField(unit.id, lesson.id, "content", e.target.value)
//                 }
//               />
...
//                 onChange={(e) =>
//                   updateLessonField(unit.id, lesson.id, "video_url", e.target.value)
//                 }
//               />
...
//                 onChange={(e) =>
//                   updateLessonField(unit.id, lesson.id, "file_url", e.target.value)
//                 }
//               />
...
//       <button
//         className="bg-purple-600 text-white px-6 py-3 rounded-lg mt-6 w-full"
...
const CreateCourseAdvanced = () => {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      const res = await axios.post("/api/courses/create-with-units", formData, {
        headers: { "Content-Type": "multipart/form-data" },
      });
      ...
      {units.map((unit) => (
        <div key={unit.id} className="bg-gray-100 p-6 rounded-lg shadow mb-6">
          ...
          <input
            className="input"
            value={unit.title}
            onChange={(e) => updateUnitField(unit.id, "title", e.target.value)}
          />
